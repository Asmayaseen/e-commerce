...
import { faArrowCircleRight, faCopyright } from '@fortawesome/free-solid-svg-icons'; // General icons
      ...
      <div className="w-full sm:h-full lg:h-[350px] bg-neutral-900 flex justify-center items-center">
        <div className="sm:pl-[5%] md:pl-[10%] lg:pl-0 w-full gap-y-9 pt-3 sm:pb-6 flex sm:flex-col lg:flex-row justify-evenly text-white">
          ...
          <div className="w-[200px]">
            ...
            <ul>
              <li className="pt-1 cursor-pointer">111 Bijoy Sarani, Karachi, DH 1515, Pakistan.</li>
          ...
          <div>
            ...
            <ul className="list-none flex gap-x-3">
              ...
              <li>
                <Link href="https://www.linkedin.com/Asmayaseen" target="_blank" rel="noopener noreferrer">
