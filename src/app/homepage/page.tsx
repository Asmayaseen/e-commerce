...
import { client } from "../../sanity/lib/client"; // Assuming you have a client.js to import
      ...
      <section className="max-w-screen-xl mx-auto mt-24 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            />
            <p className="pt-5 text-lg font-medium">Bags </p>
            <p className="pt-2 text-md text-gray-600">$99.00</p>
          </div>
          {/* Product 2 */}
          <div className="text-center">
            <Image
            ...
            <p className="pt-2 text-md text-gray-600">$190.00</p>
          </div>
          {/* Product 3 */}
          <div className="text-center">
            <Image
              ...
              className="object-cover w-full h-64 rounded-md"
            />
            <p className="pt-5 text-lg font-medium">Clothes</p>
            <p className="pt-2 text-md text-gray-600">$40.00</p>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
